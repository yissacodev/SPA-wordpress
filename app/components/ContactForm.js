export function ContactForm() {
    ...
    /*Inyectar Estilos CSS con Javascript */
    $styles.innerHTML = `
    .contact-form {
    ...
    function validationForm(){
        ...
        d.addEventListener("submit", (e) => {
            ...
            /*Verificador de formularios: https://formsubmit.co/
            Revisar documentación
            */

            fetch("https://formsubmit.co/ajax/yissacodev@gmail.com", {
                method: "POST",
    ...
    /*Para ejecutar la lógica de la funcion despues de que carge todo el DOM */
